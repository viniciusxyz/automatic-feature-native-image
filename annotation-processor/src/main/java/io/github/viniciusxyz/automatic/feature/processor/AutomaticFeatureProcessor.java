...
/**
 * Processor responsible for generating features
 */
@AutoService(Processor.class)
public class AutomaticFeatureProcessor extends AbstractProcessor {

    private static final String PATTERN_FILE = "Args=--features=%s";
    private static final List<String> LOCATION_BASE = new ArrayList<>(Arrays.asList("target", "classes", "META-INF", "native-image"));
